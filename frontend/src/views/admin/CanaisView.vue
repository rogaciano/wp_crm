              ...
              <tr v-for="canal in canais" :key="canal.id" class="hover:bg-gray-50">
                ...
                <td class="table-cell text-center">
                  <button 
                    ...
                    :class="canal.evolution_is_connected 
                      ? 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200' 
                      : canal.evolution_instance_name 
                  ...
                  >
                    ...
                    {{ canal.evolution_is_connected ? 'Conectado' : canal.evolution_instance_name ? 'Desconectado' : 'Conectar' }}
                  </button>
                </td>
