        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div class="mt-4 pt-4 border-t border-gray-50 flex justify-end gap-3">
              <button 
                v-if="getContatoPhone(contato)"
                @click="openWhatsapp(contato)" 
                class="p-2 text-emerald-500 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors"
                title="WhatsApp"
              >
